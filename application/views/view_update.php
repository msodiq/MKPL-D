    ...
    <section class="content">
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <form class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/Co_karyawan/update2" onsubmit="return cekform();">
            <div class="box-body">
              <div class="form-group">
                <label  class="col-sm-2 control-label">Nama</label>
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="nama" name="nama" placeholder= "<?php $a = $this->input->post('nama'); echo $a;?>" required>
                </div>
              </div>
              <div class="form-group">
                <label  class="col-sm-2 control-label">Tempat Tanggal Lahir</label>
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="ttl" name="ttl" placeholder="<?php $a = $this->input->post('ttl'); echo $a;?>" required="">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <select class="form-control select2" id="jk" name="jk" required="">
                    <option selected="selected"><?php $a = $this->input->post('jk'); echo $a;?></option>
                    <option>L</option>
                    <option>P</option>
                  </select>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <select class="form-control select2" id="sts" name="sts" >
                    <option selected="selected"><?php $a = $this->input->post('sts'); echo $a;?></option>
                    <option>Kawin</option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <select class="form-control select2" id="agama" name="agama" >
                    <option selected="selected"><?php $a = $this->input->post('agama'); echo $a;?></option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <textarea class="form-control" rows="3" id="alamat" name="alamat" placeholder="<?php $a = $this->input->post('alamat'); echo $a;?>" required></textarea>
                </div>
              </div>
              <div class="form-group">
